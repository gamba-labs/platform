...
export const PLATFORM_CREATOR_ADDRESS = new PublicKey(
  '3yxq4WqKyZoXDXmkHLK7EjKwPYUpoEoHSdHVQCJsfi7G',
)
...
export const PLATFORM_SHARABLE_URL = 'play.pog.tv'
...
export const TOKEN_METADATA: (Partial<TokenMeta> & {mint: PublicKey})[] = [
  {
    mint: new PublicKey('Fqv7Q7Tm5Aobetwu2WcXFq1rLb5ch5QMuPn2Hacbn7co'),
    name: 'POG',
    symbol: 'POG Coin',
